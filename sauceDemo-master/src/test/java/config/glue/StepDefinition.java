...
public class StepDefinition {
    ...
    @When("I enter uncorrect username as {string} and password as {string}")
    public void iEnterUncorrectUsernameAsUsernameAndPasswordAsPassword(String username, String password) {
        loginInPage.logIn(username, password);
    }
