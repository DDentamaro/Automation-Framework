Feature: Login
  ...
  Scenario Outline: Login with correct credentials
    ...
    Scenario Outline: Login with uncorrect credential

      When I enter uncorrect username as '<username>' and password as '<password>'
      ...
      Examples:
        ...
        |a                |sasa         | Epic sadface: Username and password do not match any user in this service|
